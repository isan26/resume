...
md-to-pdf ./tech-lead-extended/TechLead_Isan_Rodriguez.md
md-to-pdf ./tpm/TPM_Isan_Rodriguez.md
md-to-pdf ./ai-engineer/AI_Engineer_Isan_Rodriguez.md

DATE=$(date +%Y-%m-%d)
git add .
git commit -m "Updated Engineering Lead, Architect, Tech Lead, Tech Lead Extended, TPM, and AI Engineer PDFs on $DATE"
git push
